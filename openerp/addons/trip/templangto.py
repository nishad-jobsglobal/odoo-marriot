...
class tapplicant(osv.osv):
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        for r in self.browse(cr, uid, ids, context=context):
            if vals.get('user_email') == False or vals.get('gender') == False or vals.get('date_birth') == False or vals.get('homeaddress') == False or (vals.get('salary_basic') == False and vals.get('salary_gross') == False):
                if r.frprflng == 0:
            ...
            if vals.get('hascv') == False or vals.get('hasinterviewsheet') == False or vals.get('haspassport') == False or vals.get('hasoffersigned') == False or vals.get('hasphoto') == False or vals.get('formscompleted') == False or vals.get('nationality') == False or vals.get('passportnumber') == False or vals.get('passportexpiry') == False:
                if r.frdcmntcllctn == 0 and (r.frprflng == 0 or frprflng):
            ...
            if vals.get('feeplacement') == False or vals.get('feeprocessing') == False:
                if r.tpdtchrgs == 0 and (r.frprflng == 0 or frprflng):
