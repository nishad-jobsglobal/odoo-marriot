...
class tapplicant(osv.osv):
    ...
    _columns = {
        ...
        'dateclearedvisastamp': fields.date('Cleared For Visa Stamp', write=['base.group_branch_accounts']),
        ...
        'datetravelproccleared': fields.date('Cleared Travel Processing', write=['base.group_branch_accounts']),
        ...
        'dateticketissueclear': fields.date('Cleared For Ticket', write=['base.group_branch_accounts']),
        ...
        'company_id': fields.related('trip_id', 'company_id', type="many2one", relation="res.company", string="Branch"),
        'consultant_id': fields.related('trip_id', 'user_id', relation="res.users", type='many2one', string="Consultant"),
        ...
        'move_line_ids': fields.one2many('account.move.line','tapplicant_id','Move Lines', store=False ,readonly=True),
...
class account_move_line(osv.osv):
    ...
    _columns = {
            ...
            'tapplicant_id': fields.many2one('tapplicant', 'Applicant'),
            'thenumber': fields.related('move_id', 'name', type='char', string='Invoice Number' ),
            'thecurrency_id': fields.related('move_id', 'currency_id', relation="res.currency", type='many2one', string="Currency"),
            'importpid': fields.integer('Import Primary Key'),
